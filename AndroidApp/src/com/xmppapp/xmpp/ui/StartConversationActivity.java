...
import com.xmppapp.xmpp.services.XmppConnectionService.OnRosterUpdate;
import com.xmppapp.xmpp.utils.Validator;
...
public class StartConversationActivity extends XmppActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mContactsListFragment.setOnListItemClickListener(new OnItemClickListener() {
	...
	protected void showCreateContactDialog() {
		...
		dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// fixme short-ciruiting because we no longer have any
				// servers
