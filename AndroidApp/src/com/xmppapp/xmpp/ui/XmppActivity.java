...
import com.xmppapp.xmpp.services.XmppConnectionService.XmppConnectionBinder;
...
public abstract class XmppActivity extends FragmentActivity {
	...
	public void switchToConversation(Conversation conversation, String text, boolean newTask) {
		Intent viewConversationIntent = new Intent(this, MainActivity.class);
	...
	protected void announcePgp(Account account, final Conversation conversation) {
		xmppConnectionService.getPgpEngine().generateSignature(account, "online", new UiCallback<Account>() {
			...
			public void success(Account account) {
				...
				xmppConnectionService.sendPresencePacket(account, xmppConnectionService.getPresenceGenerator().sendPresence(account));
	...
	public void selectPresence(final Conversation conversation, final OnPresenceSelected listener) {
		...
		if (contact == null) {
			...
			if (presences.size() == 0) {
				...
				builder.setSingleChoiceItems(presencesArray, preselectedPresence, new DialogInterface.OnClickListener() {
