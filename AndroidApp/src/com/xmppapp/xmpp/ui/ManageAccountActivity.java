...
import com.xmppapp.xmpp.services.XmppConnectionService.OnAccountUpdate;
import com.xmppapp.xmpp.ui.EditAccountDialog.EditAccountListener;
import com.xmppapp.xmpp.ui.adapter.AccountAdapter;
			...
			public void onItemClick(AdapterView<?> arg0, View view, int position, long arg3) {
				if (!isActionMode) {
					...
					if (account.getStatus() == Account.STATUS_OFFLINE) {
						...
						activity.startActivity(new Intent(activity.getApplicationContext(), StartConversationActivity.class));
